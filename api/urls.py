...
urlpatterns = [
    ...
    path('api/tags/<int:pk>/', views.CourseTagRetriveAPIView.as_view(), name='tags-list-view'),

    path('api/types/', views.CourseTypeListAPIView.as_view(), name='types-list-view'),
    path('api/types/<int:pk>/', views.CourseTypeRetriveAPIView.as_view(), name='types-list-view'),

    path('api/effects/', views.CourseEffectListAPIView.as_view(), name='effects-list-view'),
    path('api/effects/<int:pk>/', views.CourseEffectRetriveAPIView.as_view(), name='effects-list-view'),

    path('api/semesters/', views.SemesterListAPIView.as_view(), name='semesters-list-view'),
    path('api/semesters/<int:pk>/', views.SemesterRetriveAPIView.as_view(), name='semesters-list-view'),
